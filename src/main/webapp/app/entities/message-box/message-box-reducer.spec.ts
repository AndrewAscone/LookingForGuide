...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGEBOX_LIST actions', async () => {
    ...
    it('dispatches FETCH_MESSAGEBOX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MESSAGEBOX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MESSAGEBOX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGEBOX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MESSAGEBOX actions', async () => {
      const expectedActions = [
        {
