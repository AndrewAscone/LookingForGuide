...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-gaming-account.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERGAMINGACCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERGAMINGACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERGAMINGACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERGAMINGACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERGAMINGACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERGAMINGACCOUNT actions', async () => {
      const expectedActions = [
        {
