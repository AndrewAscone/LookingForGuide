...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().messageBody(DEFAULT_MESSAGE_BODY);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().messageBody(UPDATED_MESSAGE_BODY);
        return message;
    }
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.messageBody(UPDATED_MESSAGE_BODY);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.messageBody(UPDATED_MESSAGE_BODY);
